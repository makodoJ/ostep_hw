...
long strtol_exit_is_fail(const char *str, const char *varname){
    char *endptr;
...
int main(int argc, char const *argv[]){
    ...
    int numpages = (int) strtol_exit_is_fail(argv[1], "num_pages_to_touch");
    int numtrials = (int) strtol_exit_is_fail(argv[2], "num_trials");
    ...
    //print random entry in array to standard out ot prevent compiler
